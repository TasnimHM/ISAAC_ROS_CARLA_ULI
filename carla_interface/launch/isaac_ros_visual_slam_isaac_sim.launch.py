...
def generate_launch_description():
    ...
    visual_slam_node = ComposableNode(
        ...
        # remappings=[
        #     ('visual_slam/image_0', '/carla/hero/rgb_left/image'),
        #     ('visual_slam/camera_info_0', '/carla/hero/rgb_left/camera_info'),
        #     ('visual_slam/image_1', '/carla/hero/rgb_right/image'),
        #     ('visual_slam/camera_info_1', '/carla/hero/rgb_right/camera_info')
        ],
        parameters=[{
            'use_sim_time': True,
